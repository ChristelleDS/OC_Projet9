...
from reviews.views import delete_Ticket
...
urlpatterns = [
    ...
    path('ticket/<int:ticket_id>/delete', delete_Ticket.as_view(), name='delete_ticket'),
    path('review/create/', reviews.views.createReview_Ticket, name='review_ticket'),
